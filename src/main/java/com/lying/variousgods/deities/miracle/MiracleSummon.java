...
import com.lying.variousgods.api.event.PlayerBreadcrumbEvent;
import com.lying.variousgods.entities.EntityHearthLight;
import com.lying.variousgods.entities.IGuardMob;
...
public abstract class MiracleSummon extends Miracle
{
	...
	{
		bus.addListener(this::onLivingHurtEvent);
	}
	...
	public static class HearthLight extends MiracleSummon
	{
		...
		public void addListeners(IEventBus bus)
		{
			bus.addListener(this::onBreadcrumb);
		}
		
		public void onBreadcrumb(PlayerBreadcrumbEvent event)
		{
			checkAndPerformMiracle((Player)event.getEntity());
		}
		...
		public List<Entity> getSummonsFor(Player playerIn)
		{
			...
			EntityHearthLight light = VGEntities.HEARTH_LIGHT.get().create(world);
	...
	{
		private static final Function<Level, Mob> GUARD_SKELETON = (world) -> VGEntities.GUARD_SKELETON.get().create(world);
		private static final Function<Level, Mob> GUARD_ZOMBIE = (world) -> VGEntities.GUARD_ZOMBIE.get().create(world);

package com.lying.variousgods.client.renderer.entity;
...
public class EntityHearthLightRenderer extends LivingEntityRenderer<EntityHearthLight, ModelHearthLightIndicator<EntityHearthLight>>
{
	...
	{
		super(contextIn, new ModelHearthLightIndicator<EntityHearthLight>(contextIn.bakeLayer(VGModelLayers.HEARTH_INDICATOR)), 0F);
	...
	private class LanternHandRenderer extends LivingEntityRenderer<EntityHearthLight, ModelHearthLightLantern<EntityHearthLight>>
	{
		...
		{
			super(contextIn, new ModelHearthLightLantern<>(contextIn.bakeLayer(VGModelLayers.HEARTH_LANTERN)), 0F);
	...
	{
		public IndicatorHandRenderer(Context contextIn) { super(contextIn, new ModelHearthLightIndicator<>(contextIn.bakeLayer(VGModelLayers.HEARTH_INDICATOR)), 0F); }

package com.lying.variousgods.client.model;

import com.lying.variousgods.client.renderer.Animations;
...
public class ModelHearthLightLantern<T extends EntityHearthLight> extends HierarchicalModel<T>
{
	private ModelPart root;
	
	public ModelHearthLightLantern(ModelPart partsIn)
	{
	...
	public static LayerDefinition createBodyLayer()
	{
		...
		PartDefinition thumbP = palm.addOrReplaceChild("thumbP", CubeListBuilder.create().texOffs(8, 0).addBox(0.0F, -2.0F, -1.0F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(2.0F, 0.0F, 0.0F));
		thumbP.addOrReplaceChild("thumbD", CubeListBuilder.create().texOffs(8, 0).addBox(0.0F, -2.0F, -1.0F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -2.0F, 0.0F));
	...
	public void setupAnim(T p_102618_, float p_102619_, float p_102620_, float p_102621_, float p_102622_, float p_102623_)
	{
		...
		this.animate(p_102618_.lanternHandIdle, Animations.HAND_LANTERN_IDLE, p_102621_);
	}
}

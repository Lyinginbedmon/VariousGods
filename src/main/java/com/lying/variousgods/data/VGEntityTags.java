...
public class VGEntityTags extends EntityTypeTagsProvider
{
	...
	public VGEntityTags(DataGenerator p_126517_, ExistingFileHelper helperIn)
	{
		super(p_126517_, Reference.ModInfo.MOD_ID, helperIn);
	}
	
	public String getName() { return "Various Gods entity tags"; }

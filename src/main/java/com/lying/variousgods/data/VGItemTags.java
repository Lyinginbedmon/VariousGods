...
public class VGItemTags extends ItemTagsProvider
{
	...
	public VGItemTags(DataGenerator dataGenerator, @Nullable ExistingFileHelper existingFileHelper)
	{
		super(dataGenerator, new VGBlockTags(dataGenerator, existingFileHelper), Reference.ModInfo.MOD_ID, existingFileHelper);
	}
	
	public String getName() { return "Various Gods item tags"; }
